...
namespace Zoe {
    ...
    UILayer::UILayer() : Layer("UILayer"), color({0,0,0,0}) {
...
//------------------
    ...
    void UILayer::onEvent(Event &event) {
        static std::function<bool(AppRenderEvent &)> onRenderEvent = std::bind(&UILayer::onRenderEvent, this,
                                                                               std::placeholders::_1);

        static std::function<bool(KeyPressedEvent &)> onKeyPressedEvent = std::bind(&UILayer::onKeyPressedEvent, this,
                                                                                    std::placeholders::_1);
        static std::function<bool(KeyReleasedEvent &)> onKeyReleasedEvent = std::bind(&UILayer::onKeyReleasedEvent,
                                                                                      this, std::placeholders::_1);

        static std::function<bool(MouseButtonPressedEvent &)> onMouseButtonPressedEvent = std::bind(
                &UILayer::onMouseButtonPressedEvent, this, std::placeholders::_1);
        static std::function<bool(MouseButtonReleasedEvent &)> onMouseButtonReleasedEvent = std::bind(
                &UILayer::onMouseButtonReleasedEvent, this, std::placeholders::_1);
        static std::function<bool(MouseMovedEvent &)> onMouseMoveEvent = std::bind(&UILayer::onMouseMoveEvent, this,
                                                                                   std::placeholders::_1);
...
//----------------------
    ...
    void UILayer::addEllipse(const Rect &rect, const Color &color) {
    ...
    void UILayer::addRectangle(const float &x, const float &y, const float &w,
                               const float &h, const Color &color) {
        Rect r{x, y, w, h, 0};
        addComponent(new Rectangle(r, color));
    }

    void UILayer::addRectangle(const Rect &rect, const Color &color) {
        addComponent(new Rectangle(rect, color));
    }
...
//
    ...
    void UILayer::addEllipse(const Rect &rect) {
        addComponent(new Ellipse(rect, color));
    }
    ...
    void UILayer::addRectangle(const Rect &rect) {
        addComponent(new Rectangle(rect, color));
    }
    ...
    void UILayer::addClickCallback(const Rect &rect,
...
//------------------
    ...
    void UILayer::addImage(const Rect &rect, const File &file) {
